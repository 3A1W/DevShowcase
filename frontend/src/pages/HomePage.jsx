  ...
  return (
    <div className="min-h-screen bg-white">
        <div className="mx-auto max-w-screen">
            ...
            {/* BILLBOARD IMAGE SECTION (No Text overlapping) */}
            <div className="h-[60vh] w-full pt-20 bg-fixed bg-contain bg-[position:center_top] relative" style={{ backgroundImage : `url(${logoBG})` }}>
                {/* Fade to black gradient at the bottom so it blends into the text section smoothly */}
                <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-b from-transparent to-[rgb(0,5,15)] z-0"></div>
            </div>

            {/* INTRO TEXT SECTION (Moved down below the image) */}
            <div className="bg-[rgb(0,5,15)] pt-10 pb-20 px-6 flex flex-col items-center text-center relative z-10">
                <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent mb-6 drop-shadow-lg">
                    Stop tweaking your portfolio. <br /> Start shipping it.
                </h1>
                <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-10 drop-shadow-md">
            ...
            <section className="bg-[rgb(0,5,15)] px-8 pb-20 flex flex-col items-center relative z-10">
            ...
            <div className="z-20 relative bg-[rgb(0,5,15)] px-8 pt-16 pb-48 ring-2 ring-cyan-400 shadow-[0px_0px_60px_rgba(125,216,255,0.75)]">
                <div id="snap-HowItWorks" className="">
                    <h1 className="text-center text-6xl md:text-8xl text-slate-200 font-semibold pb-32">How It Works</h1>
                </div>
                <div className="flex items-center justify-center gap-12 flex-col md:flex-row">
                    ...
                    <img src={arrow} className="h-48 w-auto hidden md:block"/>
                    <div className="relative group">
                        <img src={coloredSquare} className="h-64 w-auto origin-center transition-transform duration-500 hover:scale-x-[1.5] hover:scale-y-[1.8]"/>
            ...
            <div className="relative bg-[rgb(0,5,15)] px-8 py-20 flex flex-col items-center">
                ...
                <section className="w-full max-w-6xl px-6 py-20 border-t border-slate-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-[rgb(5,15,30)] rounded-xl h-64 border border-slate-800 flex flex-col items-center justify-center p-6 text-slate-300 hover:border-cyan-500 transition-all group">
